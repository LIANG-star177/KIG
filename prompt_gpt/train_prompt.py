...
def set_args():
    ...
    parser.add_argument('--num_train_epochs', default=25, type=int, help='模型训练的轮数')
    ...
    parser.add_argument('--prompt_lr', default=5e-5, type=float, required=False, help='学习率')
    ...
    parser.add_argument('--prompt_output_dir', default='log/ca_prompt_saved_model', type=str, help='模型输出路径')
